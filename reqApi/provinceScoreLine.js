...
provinceScoreLine.getAosAndProfTypeList = async function (params = {}) {
    return httpRequest.post( yssCaps.url + '/api/m/auth/provinceScoreLine/aosAndProfTypeList.ws' ,{ ...params});
};
...
provinceScoreLine.getProvinceList = async function (params = {}) {
    return httpRequest.post( yssCaps.url + '/api/m/auth/provinceScoreLine/provinceList.ws' ,{ ...params});
}