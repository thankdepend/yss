const transcribeManage = require('../../project/help/applyComposite/videoTest/transcribeManage');
...
describe.skip('视频录制类', async function () {
    ...
    before('登录-获取关键校验信息', async function () {
        ...
        // 获取后台考题库
        await transcribe.getExaminationList()
        // 获取科目编辑页信息
        await transcribe.getExamSubjectEdit()
        // 用户登录
